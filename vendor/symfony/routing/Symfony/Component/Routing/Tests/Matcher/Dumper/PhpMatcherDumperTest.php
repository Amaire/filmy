...
class PhpMatcherDumperTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testDumpWhenSchemeIsUsedWithoutAProperDumper() {
        ...
        $collection->add('secure', new Route(
                '/secure', array(), array('_scheme' => 'https')
        ));
    ...
    public function getRouteCollections() {
        ...
        $collection->add('barhead', new Route(
                '/barhead/{foo}', array(), array('_method' => 'GET')
        ));
        // simple
        ...
        $collection->add('baz5', new Route(
                '/test/{foo}/', array(), array('_method' => 'post')
        ));
        // complex name
        $collection->add('baz.baz6', new Route(
                '/test/{foo}/', array(), array('_method' => 'put')
        ));
        ...
        $redirectCollection->add('nonsecure', new Route(
                '/nonsecure', array(), array('_scheme' => 'http')
        ));
