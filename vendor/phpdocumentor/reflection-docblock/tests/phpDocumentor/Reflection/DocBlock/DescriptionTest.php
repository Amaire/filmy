...
LONGDESC;
        ...
        $this->assertInstanceOf(
                __NAMESPACE__ . '\Tag\LinkTag', $parsedContents[1]
        );
        $this->assertSame(
                ' that uses inline
...
LONGDESC;
        ...
        $this->assertSame(
                'This is text for a description with ', $parsedContents[0]
        );
        $this->assertInstanceOf(
                __NAMESPACE__ . '\Tag', $parsedContents[1]
        );
        ...
        $this->assertInstanceOf(
                __NAMESPACE__ . '\Tag\LinkTag', $parsedDescription[1]
        );
...
LONGDESC;
        ...
        $this->assertCount(3, $parsedContents);
        $this->assertSame(
                'This is text for a description containing ', $parsedContents[0]
        );
        $this->assertInstanceOf(
                __NAMESPACE__ . '\Tag', $parsedContents[1]
        );
...
is literal'), $parsedContents[1]->getParsedDescription()
        );
    }
...
LONGDESC;
        ...
        $this->assertCount(1, $parsedContents);
        $this->assertSame(
                'This is text for a description with } that is not a tag.', $parsedContents[0]
        );
    }
...
inline tag'), $parsedContents[1]->getParsedDescription()
        );
    }
...
LONGDESC;
        ...
        $this->assertCount(1, $parsedContents);
        $this->assertSame(
                'This is text for a description with literal {@link}.', $parsedContents[0]
        );
    }
...
LONGDESC;
        ...
        $this->assertCount(3, $parsedContents);
        $this->assertSame(
                'This is text for a description with an ', $parsedContents[0]
        );
        $this->assertInstanceOf(
                __NAMESPACE__ . '\Tag', $parsedContents[1]
        );
