...
class MatchersMaintainerSpec extends ObjectBehavior {
    ...
    PresenterInterface $presenter, ExampleNode $example, SpecificationInterface $context, MatcherManager $matchers, CollaboratorManager $collaborators, MatcherInterface $matcher) {
