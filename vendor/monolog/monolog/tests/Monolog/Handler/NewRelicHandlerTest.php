...
class NewRelicHandlerTest extends TestCase {
    ...
    public function testThehandlerCanAddExplodedContextParamsToTheNewRelicTrace() {
        ...
        $handler->handle($this->getRecord(
                        Logger::ERROR, 'log message', array('a' => array('key1' => 'value1', 'key2' => 'value2'))
        ));
        $this->assertEquals(
                array('context_a_key1' => 'value1', 'context_a_key2' => 'value2'), self::$customParameters
        );
    }
    ...
    public function testThehandlerCanAddExplodedExtraParamsToTheNewRelicTrace() {
        ...
        $this->assertEquals(
                array('extra_c_key1' => 'value1', 'extra_c_key2' => 'value2'), self::$customParameters
        );
    }
