...
abstract class PHP_CodeCoverage_TestCase extends PHPUnit_Framework_TestCase {
    ...
    protected function getCoverageForBankAccount() {
        ...
        $coverage->stop(
                true, array(TEST_FILES_PATH . 'BankAccount.php' => range(6, 9))
        );
        ...
        $coverage->stop(
                true, array(TEST_FILES_PATH . 'BankAccount.php' => range(27, 32))
        );
        ...
        $coverage->stop(
                true, array(TEST_FILES_PATH . 'BankAccount.php' => range(20, 25))
        );
