...
class Swift_ByteStream_ArrayByteStreamTest extends \PHPUnit_Framework_TestCase {
    ...
    public function testPointerNeverSetsAboveStackSize() {
        ...
        $bs->setReadPointer(3);
        $this->assertSame(false, $bs->read(1), '%s: Stream should be at end and thus return false'
        );
    }
    ...
    public function testContentsCanBeFlushed() {
        ...
        $this->assertSame(false, $bs->read(1), '%s: Contents have been flushed so read() should return false'
        );
    }
